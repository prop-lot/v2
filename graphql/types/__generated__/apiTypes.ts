...
export type ResolversTypes = {
  ...
  PropLotProfileResponse: ResolverTypeWrapper<
    Omit<PropLotProfileResponse, "list"> & {
      list?: Maybe<Array<ResolversTypes["PropLotListItems"]>>;
    }
  >;
  PropLotResponse: ResolverTypeWrapper<
    Omit<PropLotResponse, "list"> & {
      list?: Maybe<Array<ResolversTypes["PropLotListItems"]>>;
    }
  >;
...
export type ResolversParentTypes = {
  ...
  PropLotInputOptions: PropLotInputOptions;
  PropLotListItems:
    | ResolversParentTypes["Candidate"]
    | ResolversParentTypes["Comment"]
    | ResolversParentTypes["Idea"];
  PropLotProfileInputOptions: PropLotProfileInputOptions;
  PropLotProfileResponse: Omit<PropLotProfileResponse, "list"> & {
    list?: Maybe<Array<ResolversParentTypes["PropLotListItems"]>>;
  };
  PropLotResponse: Omit<PropLotResponse, "list"> & {
    list?: Maybe<Array<ResolversParentTypes["PropLotListItems"]>>;
  };
...
> = {
  ...
  ideaId?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  parent?: Resolver<
    Maybe<ResolversTypes["CommentParent"]>,
    ParentType,
    ContextType
  >;
...
export type CommentParentResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["CommentParent"] = ResolversParentTypes["CommentParent"]
> = {
  authorId?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  body?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes["Date"], ParentType, ContextType>;
...
export type DeleteDataResponseResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["DeleteDataResponse"] = ResolversParentTypes["DeleteDataResponse"]
> = {
...
export type IdeaResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Idea"] = ResolversParentTypes["Idea"]
> = {
  candidates?: Resolver<
    Maybe<Array<ResolversTypes["Candidate"]>>,
    ParentType,
    ContextType
  >;
  ...
  expiryOption?: Resolver<
    ResolversTypes["IdeaExpiryOption"],
    ParentType,
    ContextType
  >;
  ...
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  ideaStats?: Resolver<
    Maybe<ResolversTypes["IdeaStats"]>,
    ParentType,
    ContextType
  >;
  tags?: Resolver<
    Maybe<Array<ResolversTypes["IdeaTags"]>>,
    ParentType,
    ContextType
  >;
...
export type IdeaStatsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["IdeaStats"] = ResolversParentTypes["IdeaStats"]
> = {
  comments?: Resolver<Maybe<ResolversTypes["Int"]>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type IdeaTagsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["IdeaTags"] = ResolversParentTypes["IdeaTags"]
> = {
...
> = {
  deleteIdea?: Resolver<
    ResolversTypes["DeleteDataResponse"],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteIdeaArgs, "id">
  >;
  deleteIdeaComment?: Resolver<
    ResolversTypes["Comment"],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteIdeaCommentArgs, "id">
  >;
  submitCandidate?: Resolver<
    ResolversTypes["Candidate"],
    ParentType,
    ContextType,
    RequireFields<MutationSubmitCandidateArgs, "options">
  >;
  submitIdea?: Resolver<
    ResolversTypes["Idea"],
    ParentType,
    ContextType,
    RequireFields<MutationSubmitIdeaArgs, "options">
  >;
  submitIdeaComment?: Resolver<
    ResolversTypes["Comment"],
    ParentType,
    ContextType,
    RequireFields<MutationSubmitIdeaCommentArgs, "options">
  >;
  submitIdeaVote?: Resolver<
    ResolversTypes["Vote"],
    ParentType,
    ContextType,
    RequireFields<MutationSubmitIdeaVoteArgs, "options">
  >;
};

export type PropLotFilterResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["PropLotFilter"] = ResolversParentTypes["PropLotFilter"]
> = {
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  label?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
  options?: Resolver<
    Array<ResolversTypes["FilterOption"]>,
    ParentType,
    ContextType
  >;
...
export type PropLotListItemsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["PropLotListItems"] = ResolversParentTypes["PropLotListItems"]
> = {
  __resolveType: TypeResolveFn<
    "Candidate" | "Comment" | "Idea",
    ParentType,
    ContextType
  >;
};

export type PropLotProfileResponseResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["PropLotProfileResponse"] = ResolversParentTypes["PropLotProfileResponse"]
> = {
  list?: Resolver<
    Maybe<Array<ResolversTypes["PropLotListItems"]>>,
    ParentType,
    ContextType
  >;
  metadata?: Resolver<
    ResolversTypes["PropLotResponseMetadata"],
    ParentType,
    ContextType
  >;
  profile?: Resolver<
    ResolversTypes["PropLotUserProfile"],
    ParentType,
    ContextType
  >;
  sortFilter?: Resolver<
    Maybe<ResolversTypes["PropLotFilter"]>,
    ParentType,
    ContextType
  >;
  tabFilter?: Resolver<
...
export type PropLotResponseResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["PropLotResponse"] = ResolversParentTypes["PropLotResponse"]
> = {
  appliedFilterTags?: Resolver<
    Maybe<Array<ResolversTypes["AppliedFilter"]>>,
    ParentType,
    ContextType
  >;
  dateFilter?: Resolver<
...
export type PropLotResponseMetadataResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["PropLotResponseMetadata"] = ResolversParentTypes["PropLotResponseMetadata"]
> = {
  appliedFilters?: Resolver<
...
export type PropLotUserProfileResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["PropLotUserProfile"] = ResolversParentTypes["PropLotUserProfile"]
> = {
...
> = {
  ...
  >;
  getIdea?: Resolver<
    Maybe<ResolversTypes["Idea"]>,
    ParentType,
    ContextType,
    RequireFields<QueryGetIdeaArgs, "options">
  >;
  getIdeaComments?: Resolver<
    Maybe<Array<ResolversTypes["Comment"]>>,
    ParentType,
    ContextType,
    RequireFields<QueryGetIdeaCommentsArgs, "options">
  >;
  getIdeas?: Resolver<
    Maybe<Array<ResolversTypes["Idea"]>>,
    ParentType,
    ContextType,
    RequireFields<QueryGetIdeasArgs, "options">
  >;
  getPropLot?: Resolver<
    ResolversTypes["PropLotResponse"],
    ParentType,
    ContextType,
    RequireFields<QueryGetPropLotArgs, "options">
  >;
  getPropLotProfile?: Resolver<
    ResolversTypes["PropLotProfileResponse"],
    ParentType,
    ContextType,
    RequireFields<QueryGetPropLotProfileArgs, "options">
  >;
  getTags?: Resolver<
    Maybe<Array<ResolversTypes["IdeaTags"]>>,
    ParentType,
  ...
  getUser?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryGetUserArgs, "options">
  >;
};
...
> = {
  downvotesReceived?: Resolver<
    Maybe<ResolversTypes["Int"]>,
    ParentType,
    ContextType
  >;
  netVotesReceived?: Resolver<
    Maybe<ResolversTypes["Int"]>,
    ParentType,
    ContextType
  >;
